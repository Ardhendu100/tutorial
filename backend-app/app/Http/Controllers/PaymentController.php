...
class PaymentController extends Controller
{
    ...
    public function payment_refund(Request $request)
    {
        try {
            ...
            //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            $finalXvaifyStatus = hash('sha256', '/pg/v1/status/' . 'PGTESTPAYUAT' . '/' . $tid . $saltKey) . '###' . $saltIndex;
            //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            $responsestatus = Curl::to('https://api-preprod.phonepe.com/apis/merchant-simulator/pg/v1/status/' . 'PGTESTPAYUAT' . '/' . $tid)
                ->withHeader('Content-Type:application/json')
                ->withHeader('accept:application/json')
